...
export const NOT_PER_EXAMPLE = new Map([
    ...
    ['logical-polarity-lesson', 'names ONE example (56-logical-on-pin-level) and checks every device that lesson explicitly offers; no example is selected by metadata, and the test asserts the exact eleven-device denominator'],
]);
