...
```assert
# Battery 1: low internal R (0.5Ω) → terminal near EMF under light load
net battery_1.pos V 9.00 +-0.10
# Battery 2: high internal R (5Ω) → larger drop; engine value differs
# from hand-computation due to Shockley LED model and battery model
net battery_2.pos V 5.28 +-0.50
```
