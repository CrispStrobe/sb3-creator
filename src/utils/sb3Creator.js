        ...
        if (this._cUses.devices) {
            ...
            if (this._cUses.lcd) {
                out.push(
                    ...
                    '',
                    `/* I2C bus timing: t_HIGH ≥ 4.0 µs, t_LOW ≥ 4.7 µs */`,
                    `/* (NXP UM10204 table 10, 100 kHz standard mode). */`,
                    `/* Divisor 2: DJNZ is 2 cycles minimum; measured at ~2.76 cy/iter */`,
                    `/* (ucsim-stc 61bad5d).  Over-providing is safe for I2C. */`,
